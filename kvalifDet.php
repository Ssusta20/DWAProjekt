...
<?php include 'dijelovi/aside.php'?>
       <article id="center-column">
         <form class="unos" action="kvalifDet.php" method="GET">
                <h1>Lead - Kvalifikacija detalji</h1>
                ...
                if ($_GET['id'] &&  $_GET['akcija'] !="Spremi"  &&  $_GET['akcija'] !="Obriši" ){
                    $result = lm_sif_kvalif_query_det($_GET['id']);
        ...
        <?php 
             ...
             if (!empty($_GET)){
                ...
                if($akcija == "Spremi"){
                    ...
                    if (empty($id)){
                        $id = lm_sif_kvalif_insert ($sifra,$opis);
                        header("location: sifrarnici.php");
                        exit();
                        
                    }
                    else {
                        lm_sif_kvalif_update($id,$sifra,$opis);
                        header("location: sifrarnici.php");
                        exit();
                    }
